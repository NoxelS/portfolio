...
class Settings(BaseSettings):
    ...
    embedding_model: str = "embedding-bge"
    reranker_model: str = "reranking-bge"
    reranker_path: str = "/openai/rerank"
    reranker_minimum_relevance_percent: float = 0.1
    llm_model: str = "phi"
    chat_completions_path: str = "/openai/chat/completions"
    models_path: str = "/openai/models"
    chat_max_tokens: int = 256
    chat_model_context_tokens: int = 8192
    chat_context_reserved_tokens: int = 768
    embeddings_path: str = "/openai/embeddings"
